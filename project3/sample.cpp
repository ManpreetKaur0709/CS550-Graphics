...
const char *WINDOWTITLE = { "OpenGL / Project 3 -- Manpreet kaur" };
...
void Display() {
    ...
    glLoadIdentity();
    glColor3f(1., 1., 1.);
    DoRasterString(5., 5., 0., "Manpreet kaur-Project 3-Texture Mapping");
...
void InitTextures() {
    ...
    width = 1024;
    height = 512;
    unsigned char* Texture0 = BmpToTexture((char*)"s.bmp", &width, &height);
